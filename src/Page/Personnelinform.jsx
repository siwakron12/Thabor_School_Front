...
export default function Personnelinform() {
    ...
    const fetchItem = async () => {
        try {
            const response = await fetch(`${apiUrl}personnelinform/servepdf/1/`);
            if (!response.ok) {
    ...
    return (
        <>
            ...
            <Helmet>
                <meta charSet="utf-8" />
                <title>ข้อมูลครูและบุคลากรทางการศึกษา</title>
             
                </Helmet>

                <Nav />
                <div className="mx-auto mt-8 w-full lg:w-3/4 p-2">
                    <h1 className="text-red-600 text-3xl my-4">ข้อมูลครูและบุคลากรทางการศึกษา</h1>
